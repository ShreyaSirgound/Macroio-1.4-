...
public class AccountEditView extends JPanel{
    public AccountEditView() {
        ...
        JLabel label1 = new JLabel("Enter Name (First, Last)", SwingConstants.RIGHT);
        ...
        JLabel label2 = new JLabel("Enter Age", SwingConstants.RIGHT);
        ...
        JLabel label4 = new JLabel("Enter Height", SwingConstants.RIGHT);
       ...
       //weight input
        ...
        JLabel label5 = new JLabel("Enter Weight", SwingConstants.RIGHT);
        ...
        JLabel label3 = new JLabel("Enter Sex", SwingConstants.LEFT);
       ...
       //diet input
        ...
        JLabel label6 = new JLabel("Diet preferences", SwingConstants.LEFT);
        ...
        JLabel label7 = new JLabel("Activity level", SwingConstants.LEFT);
        ...
        JLabel label8 = new JLabel("Password:", SwingConstants.RIGHT);
        ...
        //TODO: fix submit button placement
